...
import WaterPressureOriginalRetModel from '../../../model/dataManage/WaterPressureOriginalRetModel'
...
interface iState {
    pageData: PageDataVo<WaterPressureOriginalRetModel>
}

export default class Waterpressure extends Component<iState> {

    state: iState = {
        pageData: new PageDataVo<WaterPressureOriginalRetModel>({})
    }
    private downloadUrl = `${baseUrl}api/v1/Original/GetWaterPressureOriginalDataExcel`;
    ...
    search = async () => {
        let pageData = await this.dataManageService.pageWp(this.originalSetModel, this.pageRequest);
        ...
        return (
            <div>
                <Card bordered={false} className="card">
                    <SearchForm deviceId={DeviceIdEnum.SHUIYA} onChange={this.onFormChange} />
                    <Table
